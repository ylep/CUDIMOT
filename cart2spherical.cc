...
int main (int argc, char* argv[]){
  ...
  NEWIMAGE::volume4D<MyType> Cartesian;
  ...
  NEWIMAGE::volume<MyType> SphericalTH(Cartesian.xsize(),Cartesian.ysize(),Cartesian.zsize());
  NEWIMAGE::volume<MyType> SphericalPH(Cartesian.xsize(),Cartesian.ysize(),Cartesian.zsize());
