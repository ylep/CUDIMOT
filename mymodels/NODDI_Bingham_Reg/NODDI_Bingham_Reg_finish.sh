...
Usage() {
    echo ""
    echo "Usage: NODDI_Bingham_Reg_finish.sh <output_directory> <models_dir>"
    echo ""
...
mv $directory/Param_11_samples.nii.gz $directory/LR_psi_samples.nii.gz
...
${models_dir}/utils/getFanningOrientation $directory/th_samples $directory/ph_samples $directory/LR_psi_samples $directory/nodif_brain_mask.nii.gz  $directory/LR_fanningDir
