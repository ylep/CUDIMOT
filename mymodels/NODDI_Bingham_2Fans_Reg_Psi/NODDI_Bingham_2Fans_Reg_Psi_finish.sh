...
Usage() {
    echo ""
    echo "Usage: NODDI_Bingham_2Fans_Reg_Psi_finish.sh <output_directory>"
    echo ""
...
mv $directory/Param_13_samples.nii.gz $directory/LR_fiso_samples.nii.gz
mv $directory/Param_14_samples.nii.gz $directory/LR_fintra_samples.nii.gz
mv $directory/Param_15_samples.nii.gz $directory/LR_ffib2_samples.nii.gz
mv $directory/Param_16_samples.nii.gz $directory/LR_kappa1_samples.nii.gz
mv $directory/Param_17_samples.nii.gz $directory/LR_beta1_samples.nii.gz
mv $directory/Param_18_samples.nii.gz $directory/LR_kappa2_samples.nii.gz
mv $directory/Param_19_samples.nii.gz $directory/LR_beta2_samples.nii.gz
...
${FSLDIR}/bin/fslmaths $directory/LR_kappa1_samples.nii.gz -sub $directory/LR_beta1_samples.nii.gz $directory/LR_concentration_b1_samples.nii.gz 
${FSLDIR}/bin/fslmaths $directory/LR_kappa2_samples.nii.gz -sub $directory/LR_beta2_samples.nii.gz $directory/LR_concentration_b2_samples.nii.gz 
...
$FSLDIR/bin/fslmaths $directory/LR_ffib2_samples.nii.gz -Tmean $directory/mean_LR_ffib2
$FSLDIR/bin/fslmaths $directory/LR_kappa1_samples.nii.gz -Tmean $directory/mean_LR_kappa1
$FSLDIR/bin/fslmaths $directory/LR_beta1_samples.nii.gz -Tmean $directory/mean_LR_beta1
$FSLDIR/bin/fslmaths $directory/LR_concentration_b1_samples.nii.gz -Tmean $directory/mean_LR_concentration_b1
$FSLDIR/bin/fslmaths $directory/LR_kappa2_samples.nii.gz -Tmean $directory/mean_LR_kappa2
$FSLDIR/bin/fslmaths $directory/LR_beta2_samples.nii.gz -Tmean $directory/mean_LR_beta2
$FSLDIR/bin/fslmaths $directory/LR_concentration_b2_samples.nii.gz -Tmean $directory/mean_LR_concentration_b2
...
${FSLDIR}/bin/fslmaths $directory/mean_LR_concentration_b1 -recip -atan -mul $Two_div_pi $directory/LR_ODIp1
${FSLDIR}/bin/fslmaths $directory/mean_LR_kappa1 -recip -atan -mul $Two_div_pi $directory/LR_ODIs1
${FSLDIR}/bin/fslmaths $directory/mean_LR_kappa1 -recip $directory/ODItot_temp1
${FSLDIR}/bin/fslmaths $directory/mean_LR_concentration_b1 -recip $directory/ODItot_temp2
${FSLDIR}/bin/fslmaths $directory/ODItot_temp1 -mul $directory/ODItot_temp2 $directory/ODItot_temp1
${FSLDIR}/bin/fslmaths $directory/ODItot_temp1 -sqrt -abs -atan -mul $Two_div_pi $directory/LR_ODItot1

${FSLDIR}/bin/fslmaths $directory/mean_LR_concentration_b2 -recip -atan -mul $Two_div_pi $directory/LR_ODIp2
${FSLDIR}/bin/fslmaths $directory/mean_LR_kappa2 -recip -atan -mul $Two_div_pi $directory/LR_ODIs2
${FSLDIR}/bin/fslmaths $directory/mean_LR_kappa2 -recip $directory/ODItot_temp1
${FSLDIR}/bin/fslmaths $directory/mean_LR_concentration_b2 -recip $directory/ODItot_temp2
${FSLDIR}/bin/fslmaths $directory/ODItot_temp1 -mul $directory/ODItot_temp2 $directory/ODItot_temp1
${FSLDIR}/bin/fslmaths $directory/ODItot_temp1 -sqrt -abs -atan -mul $Two_div_pi $directory/LR_ODItot2
...
${FSLDIR}/bin/fslmaths $directory/mean_LR_beta1 -div $directory/mean_LR_concentration_b1 -atan -mul $Two_div_pi $directory/LR_DA1
${FSLDIR}/bin/fslmaths $directory/mean_LR_beta2 -div $directory/mean_LR_concentration_b2 -atan -mul $Two_div_pi $directory/LR_DA2